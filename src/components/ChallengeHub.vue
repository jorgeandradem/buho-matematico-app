...
const games = [
  ...
  { id: 'scale', name: 'Balanza Master', icon: Scale, color: 'bg-cyan-600', desc: 'Equilibra el álgebra con pesas' },
  { id: 'pizza', name: 'Pizza Arquitecto', icon: PieChart, color: 'bg-red-500', desc: 'Prepara pedidos y domina partes' },
  { id: 'submarine', name: 'Burbujas de Álgebra', icon: Waves, color: 'bg-blue-600', desc: 'Explota el valor de X bajo el mar' },
  { id: 'soccer', name: 'Fútbol Álgebra', icon: Dribbble, color: 'bg-lime-600', desc: 'Anota goles resolviendo incógnitas' },
